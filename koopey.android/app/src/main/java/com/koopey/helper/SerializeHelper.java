...
public class SerializeHelper {
    ...
    public static void saveObject(Context context, Object obj) {
        try {
            if ((obj instanceof Location) && !(obj instanceof Asset)) {

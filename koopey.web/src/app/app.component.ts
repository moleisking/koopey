...
export class AppComponent implements OnInit {
  ...
  private actionVisibleSubscription: Subscription;
  private actionIconSubscription: Subscription;
  private currentComponentSubscription: Subscription;
  ...
  private click() {
    this.currentComponentSubscription = this.clickService.getCurrentComponent().subscribe(
      (currentComponent) => {
        if (currentComponent == CurrentComponent.AboutComponent) {
          this.clickService.setAboutClick();
        } else if (currentComponent == CurrentComponent.BarcodeScannerControlComponent) {
        ...
        } else if (currentComponent == CurrentComponent.ImageCreateComponent) {
        ...
        } else if (currentComponent == CurrentComponent.ImageUpdateComponent) {
        ...
        } else if (currentComponent == CurrentComponent.AssetUpdateComponent) {
        ...
        } else if (currentComponent == CurrentComponent.SearchAssetComponent) {
          this.clickService.setAssetCreateClick();
        } else if (currentComponent == CurrentComponent.SearchAssetsComponent) {
          this.clickService.setSearchAssetsClick();
        } else if (currentComponent == CurrentComponent.SearchTransactionComponent) {
          this.clickService.setSearchTransactionClick();
        } else if (currentComponent == CurrentComponent.SearchTransactionsComponent) {
          this.clickService.setSearchTransactionsClick();
        } else if (currentComponent == CurrentComponent.SearchMemberComponent) {
          this.clickService.setSearchMemberClick();
        } else if (currentComponent == CurrentComponent.SearchServicesComponent) {
          this.clickService.setSearchServicesClick();
        } else if (currentComponent == CurrentComponent.TransactionCreateComponent) {
          this.clickService.setTransactionCreateClick();
        } else if (currentComponent == CurrentComponent.TransactionListComponent) {
          this.clickService.setTransactionListClick();
        } else if (currentComponent == CurrentComponent.TransactionUpdateComponent) {
          this.clickService.setTransactionUpdateClick();
        } else if (currentComponent == CurrentComponent.UserCalendarComponent) {
        ...
        } else if (currentComponent == CurrentComponent.AssetCreateComponent) {
          this.clickService.setAssetCreateClick();
        }
      },
      (error) => { this.actionVisible = false; },
      () => { });
    /**/
  }
  ...
  private gotoMyProducts() {
    if (this.isAuthenticated()) {
      this.router.navigate(["/asset/read/my/list"], { 'queryParams': { 'type': 'product' } });
    }
  }

  private gotoMyServices() {
    if (this.isAuthenticated()) {
      this.router.navigate(["/asset/read/my/list"], { 'queryParams': { 'type': 'service' } });
    }
  }
  ...
  private gotoSearchProducts() {
    if (this.isAuthenticated()) {
      this.router.navigate(["/asset/search/products"], { 'queryParams': { 'type': 'product' } });
    }
  }

  private gotoSearchServices() {
    if (this.isAuthenticated()) {
      this.router.navigate(["/asset/search/services"], { 'queryParams': { 'type': 'service' } });
    }
  }

...
export class ChessHelper {
    ...
    public static AlgebraicNotation(startPiece: Piece, endPiece: Piece, moveType: MoveType): string {
        if (moveType == MoveType.KingSideCastle) {
            ...
            algebraicNotation += ChessHelper.ColorToLetter(endPiece.color) + ChessHelper.PieceToLetter(endPiece.type) + ChessHelper.RankNumberToLetter(startPiece.rank) + startPiece.file;
            ...
            //End position
            algebraicNotation += ChessHelper.RankNumberToLetter(endPiece.rank) + endPiece.file;
            //Special notes
    ...
    private static isCastleMove(game: Game, startPiece: Piece, endPiece: Piece) {
        ...
        if ((startPiece.type == PieceType.King) && (startPiece.moves == 0) && !BoardHelper.isObstacleMove(game, startPiece, endPiece)) {
            //Common features of blue castle (bottom)
            if ((startPiece.color == PlayerType.Blue) && (startPiece.file == 8) && (startPiece.rank == 1) && (endPiece.rank == 1)) {
                //Queen side castle
                if ((endPiece.file == 4) || (endPiece.file == 5) || (endPiece.file == 6)) {
                    var castlePiece = BoardHelper.getSquarePieceByPosition(game, 4, 1);
                    if (!Piece.isEmpty(castlePiece) && castlePiece.color == PlayerType.Blue && castlePiece.type == PieceType.Rook && castlePiece.moves == 0) {
                        return true;
                    }
            ...
            } else if ((startPiece.color == PlayerType.Green) && (startPiece.file == 1) && (endPiece.file == 1) && (startPiece.rank == 8)) {
                //Queen side castle
                if ((endPiece.rank == 4) || (endPiece.rank == 5) || (endPiece.rank == 6)) {
                    var castlePiece = BoardHelper.getSquarePieceByPosition(game, 1, 4);
                    if (!Piece.isEmpty(castlePiece) && castlePiece.color == PlayerType.Green && castlePiece.type == PieceType.Rook && castlePiece.moves == 0) {
                        return true;
                    }
            ...
            } else if ((startPiece.color == PlayerType.Red) && (startPiece.file == 7) && (startPiece.rank == 14) && (endPiece.rank == 14)) {
                //Queen side castle
                if ((endPiece.file == 9) || (endPiece.file == 10) || (endPiece.file == 11)) {
                    var castlePiece = BoardHelper.getSquarePieceByPosition(game, 11, 14);
                    if (!Piece.isEmpty(castlePiece) && castlePiece.color == PlayerType.Red && castlePiece.type == PieceType.Rook && castlePiece.moves == 0) {
                        return true;
                    }
            ...
            } else if ((startPiece.color == PlayerType.Yellow) && (startPiece.file == 14) && (endPiece.file == 14) && (startPiece.rank == 7)) {
                //Queen side castle
                if ((endPiece.rank == 9) || (endPiece.rank == 10) || (endPiece.rank == 11)) {
                    var castlePiece = BoardHelper.getSquarePieceByPosition(game, 14, 11);
                    if (!Piece.isEmpty(castlePiece) && castlePiece.color == PlayerType.Yellow && castlePiece.type == PieceType.Rook && castlePiece.moves == 0) {
                        return true;
                    }
    ...
    private static isCheck(game: Game, pieceType: PieceType, playerType: PlayerType): boolean {
        //TODO
        //See if player is in check
        var kingPiece: Piece = BoardHelper.getSquarePieceByTypeAndColor(game, pieceType, playerType);
    ...
    public static isLegalMove(game: Game, startPiece: Piece, endPiece: Piece): boolean {
        ...
        if (!BoardHelper.isSquareFriend(game, endPiece) && (startPiece.type == endPiece.type) && (startPiece.color == game.token)) {
    ...
    public static isLegalPawnMove(game: Game, startPiece: Piece, endPiece: Piece): boolean {
        console.log(" isPawnMove");
        console.log(startPiece);
        console.log(endPiece);
        var blocks: number = BoardHelper.getSquareCount(startPiece, endPiece);
        var obsticle: boolean = BoardHelper.isObstacleMove(game, startPiece, endPiece);
        var lineType: LineType = BoardHelper.getLineType(startPiece, endPiece);
        var squareType = BoardHelper.getSquareType(game, endPiece);
        if (startPiece.type == PieceType.Pawn && blocks >= 1 && blocks <= 2 && BoardHelper.isRelativeForwardMove(startPiece, endPiece)) {
            if (startPiece.moves == 0 && blocks == 2 && !obsticle) {
                return true; //First move jump
            } else if (blocks == 1 && !obsticle
            ...
            } else if ((BoardHelper.isRelativeLeftMove(startPiece, endPiece) || BoardHelper.isRelativeRightMove(startPiece, endPiece)) && (squareType == SquareType.Enemy)) {/*ChessHelper.isCaptureMove(game, endPiece)*/
    ...
    private static isLegalRookMove(game: Game, startPiece: Piece, endPiece: Piece): boolean {
        if ((startPiece.type == PieceType.Rook) && (endPiece.type == PieceType.Rook)) {
            ...
            if (!obsticle && (lineType == LineType.PositiveHorizontal || lineType == LineType.PositiveVerticle || lineType == LineType.NegativeHorizontal || lineType == LineType.NegativeVerticle)) {
                return true;
            } else {
                return false;
            }
    ...
    private static isLegalBishipMove(game: Game, startPiece: Piece, endPiece: Piece): boolean {
        if ((startPiece.type == PieceType.Bishop) && (endPiece.type == PieceType.Bishop)) {
            var obsticle = BoardHelper.isObstacleMove(game, startPiece, endPiece);
            var lineType = BoardHelper.getLineType(startPiece, endPiece);
            if (!obsticle && (lineType == LineType.PositiveIncreaseDiagonal || lineType == LineType.NegativeIncreaseDiagonal || lineType == LineType.PositiveDecreaseDiagonal || lineType == LineType.NegativeDecreaseDiagonal)) {
                return true;
            } else {
                return false;
            }
    ...
    private static isLegalKnightMove(startPiece: Piece, endPiece: Piece): boolean {
        if ((startPiece.type == PieceType.Knight) && (endPiece.type == PieceType.Knight)) {
    ...
    private static isLegalQueenMove(game: Game, startPiece: Piece, endPiece: Piece): boolean {
        if ((startPiece.type == PieceType.Queen) && (endPiece.type == PieceType.Queen)) {
            var obsticle = BoardHelper.isObstacleMove(game, startPiece, endPiece);
            var lineType = BoardHelper.getLineType(startPiece, endPiece);
    ...
    private static isLegalKingMove(game: Game, startPiece: Piece, endPiece: Piece): boolean {
    ...
    public static isPawnPromotionMove(endPiece: Piece): boolean {
        if ((endPiece.type == PieceType.Pawn) && (endPiece.color == PlayerType.Blue) && (endPiece.rank >= 8)) {
            return true;
        } else if ((endPiece.type == PieceType.Pawn) && (endPiece.color == PlayerType.Green) && (endPiece.file >= 8)) {
            return true;
        } else if ((endPiece.type == PieceType.Pawn) && (endPiece.color == PlayerType.Red) && (endPiece.rank >= 7)) {
            return true;
        } else if ((endPiece.type == PieceType.Pawn) && (endPiece.color == PlayerType.Yellow) && (endPiece.file >= 7)) {
            return true;
        } else {
            return false;
        }

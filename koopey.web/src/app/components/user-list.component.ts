...
export class UserListComponent implements OnInit, OnDestroy {
    ...
    //Strings   
    private LOG_HEADER: string = "UserListComponent"
    //Numbers
    ...
    ngOnInit() {
        this.searchSubscription = this.searchService.getSearch().subscribe(
            ...
            () => { if (!Config.system_production) { console.log(this.search); }});
    ...
    ngAfterContentInit() {
        this.clickService.createInstance(ActionIcon.MAP, CurrentComponent.UserListComponent);
        this.clickSubscription = this.clickService.getUserListClick().subscribe(() => {
            this.gotoUserMap();
        });
    }

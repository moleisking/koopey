...
import { Component, ElementRef, EventEmitter, OnInit, OnDestroy, ViewChild } from "@angular/core";
...
export class UserUpdateComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.form = this.formBuilder.group({
            ...
            name: [this.authUser.name, [Validators.required, Validators.minLength(5), Validators.maxLength(150)]],
    ...
    ngAfterContentInit() {
        this.clickService.createInstance(ActionIcon.UPDATE, CurrentComponent.UserUpdateComponent)
        this.clickSubscription = this.clickService.getUserUpdateClick().subscribe(() => {
            this.update();
        });
    }

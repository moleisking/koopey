    ...
    ngOnInit() {
        ...
        this.route.params.subscribe(p => {
            ...
            if (id) {
                ...
                console.log("this.assetSubscription = this.assetService.getAsset().subscribe(")
   ...
   /* private getReviewAverage(): number {
    ...
    private setReviews() {     
        console.log("setReviews()");
         this.reviewSubscription = this.reviewService.readAssetReviews(this.asset).subscribe(
            (reviews) => { this.asset.reviews = reviews; },
            (error) => { console.log(error); },
            () => { }
        );
    }
    ...
    private setTransactionName() {
        this.translateService.get("PRODUCT").subscribe(
            (translatedPhrase: string) => {
                this.transaction.description = <any>translatedPhrase + ": " + this.asset.title
            }
        );

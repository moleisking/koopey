...
export class GameService extends BaseService {
  ...
  public create(game: Game): Observable<String> {
    ...
    return this.httpClient.put<String>(url, game, this.privateHttpHeader);
  }
  ...
  public readGame(game: Game): Observable<Game> {
    ...
    return this.httpClient.get<Game>(url, this.privateHttpHeader);
  }

  public readGamesEnded(): Observable<Array<Game>> {
    var url = Environment.ApiUrls.KoopeyApiUrl + "/game/read/many/ended";
    return this.httpClient.get<Array<Game>>(url, this.privateHttpHeader);
  }
  ...
  public updateGameStart(game: Game): Observable<String> {
    ...
    return this.httpClient.post<String>(url, game, this.privateHttpHeader);
  }

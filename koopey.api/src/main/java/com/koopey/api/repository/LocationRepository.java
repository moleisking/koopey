...
public interface LocationRepository extends BaseRepository<Location, UUID> {
        ...
        @NotNull
        public Optional<Location> findById(@NotNull @Param("id") UUID id);
        ...
        public Page<List<Location>> findByAreaAsKilometer(@Param("latitude") BigDecimal latitude,
                        @Param("longitude") BigDecimal longitude, @Param("range") Integer radius, Pageable pageable);
        ...
        @Query(nativeQuery = true, value = "SELECT L.* FROM Transaction T "
                        + "INNER JOIN Location L ON  L.id = T.destination_id " + "WHERE T.asset_id = :asset_id")
        public Page<List<Location>> findByAssetAndDestination(@Param("asset_id") UUID assetId, Pageable pageable);
        ...
        @Query(nativeQuery = true, value = "SELECT L.* FROM Transaction T "
                        + "INNER JOIN Location L ON  L.id = T.source_id " + "WHERE T.asset_id = :asset_id")
        public Page<List<Location>> findByAssetAndSource(@Param("asset_id") UUID assetId, Pageable pageable);
        ...
        @Query(nativeQuery = true, value = "SELECT L.* FROM Transaction T "
                        + "INNER JOIN Location L ON  L.id = T.destination_id " + "WHERE T.buyer_id = :buyer_id")
        public Page<List<Location>> findByBuyerAndDestination(@Param("buyer_id") UUID userId, Pageable pageable);
        ...
        @Query(nativeQuery = true, value = "SELECT L.* FROM Transaction T "
                        + "INNER JOIN Location L ON  L.id = T.source_id " + "WHERE T.buyer_id = :buyer_id")
        public Page<List<Location>> findByBuyerAndSource(@Param("buyer_id") UUID userId, Pageable pageable);
        ...
        @Query(nativeQuery = true, value = "SELECT L.* FROM Transaction T"
                        + "INNER JOIN Location L ON L.id = T.destination_id " + "WHERE T.destination_id = :location_id")
        public Page<List<Location>> findByDestination(@Param("location_id") UUID locationId, Pageable pageable);
        ...
        @Query(nativeQuery = true, value = "SELECT L.* FROM Transaction T "
                        + "INNER JOIN Location L ON  L.id = T.destination_id " + "WHERE T.seller_id = :seller_id")
        public Page<List<Location>> findByDestinationAndSeller(@Param("seller_id") UUID userId, Pageable pageable);

        public List<Location> findByOwnerId(@Param("owner_id") UUID ownerId);
        ...
        @Query(nativeQuery = true, value = "SELECT L.* FROM Transaction T "
                        + "INNER JOIN Location L ON  L.id = T.source_id " + "WHERE T.seller_id = :seller_id")
        public Page<List<Location>> findBySellerAndSource(@Param("seller_id") UUID userId, Pageable pageable);
        ...
        public Page<List<Location>> findBySource(@Param("source_id") UUID locationId, Pageable pageable);
}
